...
def outseltoxls(pm, selids):
    ...
    if pm == '隐形网':
        ...
        headers = (
            u"订单号", u"小区",u"地址",  u"房间", u"客户",u"电话", u"产品", u"位置", u"数量", u"型号", u"宽（毫米）", u"高（毫米）", u"蹲高（毫米）", u'栏高（毫米）', u'管位', u"颜色",
            u"备注",   u"业务员（电话）")
...
def outtoxls(pm):
    ...
    if pm == '隐形网':
        ...
        headers = (
            u"订单号", u"产品", u"位置", u"数量", u"型号", u"宽（毫米）", u"高（毫米）", u"蹲高（毫米）", u'栏高（毫米）', u'管位', u"颜色",
